...
public class PhoneBook implements Comparable {
	...
	public static PhoneBook[] phoneBookArr = new PhoneBook[3];
	public static PhoneBook[] family = new PhoneBook[3];
	public static PhoneBook[] friends = new PhoneBook[3];

	public PhoneBook(String name, String gender, long mob) {
	...
	public PhoneBook(String name, String gender, long mob, String email) {
					...
					if (!gender_Validation(g)) {
						...
						if (response.equals("yes")) {
							...
							case "yes": {
								...
								int gp = t.nextInt();
								if (gp == 1) {
									PhoneBook p = new PhoneBook(n, g, mob);
									family[famp++] = p;
									phoneBookArr[cp++] = p;
									System.out.println(" Contact registered in Family");
